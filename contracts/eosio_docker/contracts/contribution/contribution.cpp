...
// Smart Contract Name: contribution
// Table struct:
...
CONTRACT contribution : public eosio::contract {
  private:
  ...
  public:
    ...
    // constructor
    contribution( name receiver, name code, datastream<const char*> ds ):
...
EOSIO_DISPATCH( contribution, (update) )
