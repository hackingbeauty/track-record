...
cleos create account eosio contribacc EOS6PUh9rs7eddJNzqgqDx1QrspSHLRxLMcRdwHZZRL4tpbtvia5B EOS8BCgapgYA2L4LJfCzekzeSr3rzgSTUXRXwNi8bNRoz31D14en9
cleos create account eosio rewardacc EOS6PUh9rs7eddJNzqgqDx1QrspSHLRxLMcRdwHZZRL4tpbtvia5B EOS8BCgapgYA2L4LJfCzekzeSr3rzgSTUXRXwNi8bNRoz31D14en9
...
deploy_contract.sh contribution contribacc notechainwal $(cat notechain_wallet_password.txt)
deploy_contract.sh reward rewardacc notechainwal $(cat notechain_wallet_password.txt)
